...
public class RegistrationEventListener {
    ...
    private void sendWelcomeEmail(edu.cit.laurente.laundryhub.shared.entity.User user) {
        // TODO: Implement email service integration
        System.out.println("Sending welcome email to: " + user.getEmail());
        // Example: emailService.sendWelcomeEmail(user.getEmail(), user.getName());
    }

    private void logRegistrationActivity(edu.cit.laurente.laundryhub.shared.entity.User user) {
    ...
    private void initializeUserProfile(edu.cit.laurente.laundryhub.shared.entity.User user) {
